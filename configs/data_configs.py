...
from configs.paths_config import dataset_paths,DA_dataset_paths
...
DATASETS = {
	...
	'DA': {
		'transforms': transforms_config.SketchToImageTransforms,
		'train_source_root': DA_dataset_paths['celeba_train_sketch'],
		'train_target_root': DA_dataset_paths['celeba_train'],
		'test_source_root': DA_dataset_paths['celeba_test_sketch'],
		'test_target_root': DA_dataset_paths['celeba_test'],
	},
	'celebs_seg_to_face': {
