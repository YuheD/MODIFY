...
class SynthesisNetwork(nn.Cell):
    ...
    def construct(self, ws, ret_fea = False, **block_kwargs):
...
class Generator(nn.Cell):
    ...
    def construct(self, z, c, truncation_psi=0.5, truncation_cutoff=None, ret_fea=False, **synthesis_kwargs):
        """Generator construct"""
        ws = self.mapping(z, c, truncation_psi=truncation_psi, truncation_cutoff=truncation_cutoff)
        img = self.synthesis(ws, ret_fea=ret_fea  **synthesis_kwargs)
        return img
